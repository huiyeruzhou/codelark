        ...
        <section class="page" data-page="commands">
          ...
          <div class="command-item"><div class="command-col-command"><code>/t n 100</code></div><div class="command-col-original"><code>/threads n 100</code></div><div class="command-col-desc">列出当前 runtime 最近 100 条本地会话；也可用 <code>/t codex n 100</code> 或 <code>/t claude n 100</code>。</div></div>
              ...
              <div class="command-item"><div class="command-col-command"><code>/t 序号范围</code></div><div class="command-col-original"><code>/t</code></div><div class="command-col-desc"><code>/t</code> 和 <code>/t archive</code> 使用当前 runtime 的本地会话表序号。</div></div>
                  ...
                  <div class="command-item"><div class="command-col-command"><code>/auto 10m 检查实验进度</code></div><div class="command-col-original"><code>/auto &lt;时间&gt; &lt;prompt&gt;</code></div><div class="command-col-desc">创建定时 prompt 自动任务；时间支持 s/m/h/d，默认 s；每次触发都会启动新的 session。</div></div>
                  <div class="command-item"><div class="command-col-command"><code>/auto ls</code></div><div class="command-col-original"><code>/auto ls</code></div><div class="command-col-desc">查看当前聊天的自动化任务；飞书会返回绿色卡片。</div></div>
                  <div class="command-item"><div class="command-col-command"><code>/auto-script new &lt;scriptpath&gt; &lt;times&gt;</code></div><div class="command-col-original"><code>/auto-script new</code></div><div class="command-col-desc">创建脚本自动化任务；脚本退出时 stdout 会作为下一轮 Codex prompt。</div></div>
                  ...
                  <div class="command-item"><div class="command-col-command"><code>/auto set &lt;序号&gt; &lt;times&gt;</code></div><div class="command-col-original"><code>/auto set</code></div><div class="command-col-desc">重置脚本任务触发次数并设置总次数；<code>0</code> 表示暂停。</div></div>
                  <div class="command-item"><div class="command-col-command"><code>/auto-script skill install|uninstall</code></div><div class="command-col-original"><code>/auto-script skill</code></div><div class="command-col-desc">安装或删除“如何创建 /auto-script 脚本”的 Codex skill。</div></div>
