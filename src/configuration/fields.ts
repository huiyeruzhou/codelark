...
// 配置字段注册表：集中描述当前版本的 canonical path、TOML path、可写 scope、env/CLI 映射和 secret 标记。
// 旧字段只应在 migration/legacy adapter 中解释，运行时新增字段必须先进入这里。
...
export const configFields = [
  ...
  {
    path: 'runtime.kimi.model',
    tomlPath: 'runtime.kimi.model',
    scopes: sessionScopes,
    schema: z.string(),
    envKey: 'CODELARK_KIMI_MODEL',
    runtimeSettingsKey: 'bridge_kimi_default_model',
    parseEnv: stringFromEnv,
  },
  {
    path: 'runtime.kimi.provider',
    tomlPath: 'runtime.kimi.provider',
    scopes: sessionScopes,
    schema: kimiProviderSchema,
    envKey: 'CODELARK_KIMI_PROVIDER',
    runtimeSettingsKey: 'bridge_kimi_provider',
  ...
  },
  {
    ...
    scopes: sessionScopes,
    schema: z.string(),
    envKey: 'CODELARK_CURSOR_MODEL',
    runtimeSettingsKey: 'bridge_cursor_default_model',
    parseEnv: stringFromEnv,
  },
  {
    path: 'runtime.cursor.provider',
    tomlPath: 'runtime.cursor.provider',
    scopes: sessionScopes,
    schema: cursorProviderSchema,
    envKey: 'CODELARK_CURSOR_PROVIDER',
    runtimeSettingsKey: 'bridge_cursor_provider',
    parseEnv: enumFromEnv(cursorProviderSchema),
  },
  {
    path: 'runtime.cursor.force',
  ...
  {
    path: 'runtime.zcode.model',
    tomlPath: 'runtime.zcode.model',
    scopes: sessionScopes,
    schema: z.string(),
    envKey: 'CODELARK_ZCODE_MODEL',
    runtimeSettingsKey: 'bridge_zcode_default_model',
    parseEnv: stringFromEnv,
    commandAliases: ['/model'],
    defaultWriteScope: 'channel',
  },
  {
    path: 'runtime.zcode.provider',
    tomlPath: 'runtime.zcode.provider',
    scopes: sessionScopes,
    schema: zcodeProviderSchema,
    envKey: 'CODELARK_ZCODE_PROVIDER',
    runtimeSettingsKey: 'bridge_zcode_provider',
    parseEnv: enumFromEnv(zcodeProviderSchema),
  },
  {
    path: 'runtime.zcode.mode',
    tomlPath: 'runtime.zcode.mode',
    scopes: sessionScopes,
    schema: zcodeModeSchema,
    envKey: 'CODELARK_ZCODE_MODE',
    runtimeSettingsKey: 'bridge_zcode_mode',
    parseEnv: enumFromEnv(zcodeModeSchema),
    commandAliases: ['/mode'],
    defaultWriteScope: 'channel',
  },
  {
