...
- `updateCardMetadata()`：runtime/model/bridge 标签。
...
| ------------------ | ------------------------------ | --------------------------------------- | ---------------------------------------- | ---------------------------------- |
| Header             | header title、`streaming_tag_*` | stream metadata、runtime/model/bridge 标签 | metadata 变化触发 `card.update` full refresh | 关闭流式后 final `card.update`          |
| Metadata body tags | `streaming_tag_*`              | stream metadata tags                    | full refresh                             | final `card.update`                |
